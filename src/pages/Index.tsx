    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-8 py-8">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h1 className="text-3xl font-heading font-extrabold">{greeting}, {user?.name || "Builder"}!</h1>
            <p className="text-muted text-sm mt-1">{dateStr} • Let's build momentum.</p>
          </div>
          <div className="text-right">
            <span className="text-2xl font-heading font-extrabold text-primary">{store.progressPercent}%</span>
            <span className="text-sm font-heading font-bold text-muted ml-1">Daily Goal</span>
      ...
      {/* FAB */}
      <motion.button
        className="fixed bottom-8 right-8 w-14 h-14 rounded-full bg-primary text-primary-foreground border-game shadow-tactile flex items-center justify-center btn-press"
        onClick={() => setModalOpen(true)}
